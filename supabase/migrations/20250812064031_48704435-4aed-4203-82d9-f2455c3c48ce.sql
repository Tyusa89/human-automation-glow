-- First, add user_id column to results table if it doesn't exist
...
-- For results without user_id (existing records), allow admin/owner to see all
create policy results_select_admin_all
on public.results for select
to authenticated
using (public.is_admin_or_owner());

-- Future results with user_id: users see their own
