...
const templates = [
  ...
  },
  {
    ...
    hero: "/assets/template-card-design.png",
    gallery: ["/assets/template-card-design.png"],
    description: "Enterprise-grade data warehouse synchronization with ETL pipelines and multi-source ingestion.",
    features: ["Multi-source ingestion", "Automated transformations", "Real-time or scheduled sync"],
